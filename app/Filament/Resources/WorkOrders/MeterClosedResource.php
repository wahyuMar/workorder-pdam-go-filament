...
use App\Filament\Resources\WorkOrders\Pages\ListMeterClosed;
use App\Filament\Resources\WorkOrders\Tables\MeterClosedTable;
...
class MeterClosedResource extends Resource
{
    ...
    {
        return MeterClosedTable::configure($table);
    }
